    ...
    $('#mobileUndo').click(function(e) {
        ...
        OO.ui.prompt('Add a reason to your edit summary !', {
			...
			$.when(mw.loader.using('mediawiki.api')).then(function() {
				return new mw.Api().getMessages(['undo-summary'],{ amlang: mw.config.get('wgServerName').split('.wik')[0]});
            ...
            if (customEditSummary !== null) {
                ...
                api.postWithToken('csrf', {
                    ...
                    $('.mw-mf-diff-info').append('<br><div id="mobileUndo-info" style="font-size:90%; background:#FFC0CB; padding:5px;">' +
